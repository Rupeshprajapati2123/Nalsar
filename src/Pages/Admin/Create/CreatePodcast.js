...
const CreatePost = () => {
  ...
  const scenesCollectionRef = collection(db, "conversations");
  ...
  return (
    <div>
      <div className="create-page">
        ...
        <div className="create-input-flex">
          <div className="create-label">Podcast</div>
          <input
        ...
        <button className="load-more" onClick={handlePublish}>
          {!publishing ? "Publish Blog" : "Publishing..."}
        </button>
